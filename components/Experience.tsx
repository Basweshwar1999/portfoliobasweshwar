            ...
            {EXPERIENCE_DATA.map((exp, index) => (
              ...
              >
                ...
                <div className="flex-1 w-full pl-8 md:pl-0">
                  <div className={`bg-card p-6 rounded-xl border border-slate-700 hover:border-primary/50 transition-colors shadow-lg group ${index % 2 === 0 ? 'md:mr-12' : 'md:ml-12'
                    }`}>
                    <div className="flex flex-col md:flex-row md:items-start gap-4">
                      {/* Cover Image
                      <div className="w-full md:w-48 flex-shrink-0">
                        <img src={coverImg} alt="cover" className="w-full h-40 md:h-48 object-cover rounded-md" />
                      </div> */}

                      <div className="flex-1">
                        <div className="flex items-start justify-between mb-4">
                          <div className="flexdirection-row flex items-center gap-4">
                            <div>
                            ...
                            <div className="w-full md:w-48 flex-shrink-0">
                              <img src={exp.coverImg} alt="cover" className="w-full h-40 md:h-48 object-contain rounded-md" />
                            </div>
